...
namespace GOP.ViewModels
{
    ...
    {
        public GopUser GopUser { get; set; }
        public DateTimeOffset ConnectionTime { get; set; }
        public bool IsLoggedIn { get { return GopUser.UserId != null; } }
        public bool IsMobile { get; set; }
        ...
        private static bool IsRequestMobile(HttpContext context)
        {
    ...
    public class ChatMessageViewUser
    {
        [JsonProperty("username")]
        public string Username { get; set; }
        [JsonProperty("chatColor")]
    ...
    public class ChatMessageView
    {
        ...
        [JsonProperty("user")]
        public ChatMessageViewUser User { get; set; }
        [JsonProperty("text")]
