declare namespace alt1 {
    ...
    interface Alt1PressedEvent extends Event {
        text: string,
        mouseAbs: Point,
        mouseRs: Point,
        x: number,
    ...
    interface MenuDetectedEvent extends Event {
        rectangle: Rect
    }
    ...
    let openInfo: string;
    /**
     * The list of alt1 events.
     */
    let events: {
        [name: string]: Array<(e: Event) => any>,
        alt1pressed: Array<(e: Alt1PressedEvent) => any>,
        menudetected: Array<(e: MenuDetectedEvent) => any>,
        interfacefound: Array<(e: Event) => any>,
        interfacesearching: Array<(e: Event) => any>,
        interfacenotfound: Array<(e: Event) => any>,
        interfaceread: Array<(e: Event) => any>,
        xprise: Array<(e: Event) => any>,
        xpcounter: Array<(e: Event) => any>,
        rslinked: Array<(e: Event) => any>,
        rsunlinked: Array<(e: Event) => any>,
        posreset: Array<(e: Event) => any>,
        permissionchanged: Array<(e: Event) => any>,
        daemonrun: Array<(e: Event) => any>,
        userevent: Array<(e: Event) => any>,
        rsfocus: Array<(e: Event) => any>,
        rsblur: Array<(e: Event) => any>
    };
     ...
     */
    function setStatusText(text: string): any;
    /**
     ...
     * [Overlay] permission required.
     */
    function overLayImage(x: number, y: number, imgstr: string, imgwidth: number, time: number): any;
    /**
     ...
     * [Pixel] permission required.
     */
    function getRegionMulty(rectsjson: string): string;
    /**
