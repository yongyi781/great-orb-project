// GOP Engine tests
function gopTestSinglePlayer(description, playerLocation, orbs, altar, actionsStr, expectedPlayerLocations, expectedOrbFinalLocations, expectedScore) {
...
gopTestSinglePlayer("Air orb near portal correct drag #2", new Point(1, 2), [new Point(-5, -8)], Altar.Air, "*AAA", [new Point(1, 2), new Point(2, 1), new Point(2, 1)], [new Point(-4, -6)], 0);
gopTestSinglePlayer("Prototick when clicking moving orb again", new Point(0, -2), [new Point(-5, 1)], Altar.Air, "*AA(-3,0)*AA", [new Point(-2, -2), new Point(-2, -2), new Point(-3, 0), new Point(-3, 0), new Point(-4, 0)], [new Point(-3, 0)], 0);
